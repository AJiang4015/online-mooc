...
export default [
    ...
    children: [
      ...
      },
      {
        ...
        meta: {
          title: "添加编辑",
          hidden: true,
          fmeta: { path: "/curriculum/index", title: "课程管理" },
        },
      },
      {
        path: "details/:id",
    ...
    children: [
      ...
      },
      {
        ...
        meta: {
          title: "考试详情",
          hidden: true,
          fmeta: { path: "/exam/index", title: "考试管理" },
        },
      },
      {
        path: "title/add/:id",
        ...
        meta: {
          title: "添加编辑",
          hidden: true,
          fmeta: { path: "/exam/title/", title: "题目管理" },
        },
      },
      {
  ...
  },
  {
    ...
    meta: {
      title: "数据中心",
      icon: '<svg t="1750485736348" class="icon" style="margin-bottom:18px" viewBox="0 0 1024 1024"  version="1.1" xmlns="http://www.w3.org/2000/svg" p-id="4670" width="20" height="20"><path d="M512 938.666667C276.362667 938.666667 85.333333 747.637333 85.333333 512S276.362667 85.333333 512 85.333333s426.666667 191.029333 426.666667 426.666667-191.029333 426.666667-426.666667 426.666667z m0-64c200.298667 0 362.666667-162.368 362.666667-362.666667S712.298667 149.333333 512 149.333333 149.333333 311.701333 149.333333 512s162.368 362.666667 362.666667 362.666667z m8.213333-265.674667l-81.429333-88.704-95.754667 99.264a32 32 0 1 1-46.058666-44.437333l119.36-123.733334a32 32 0 0 1 46.613333 0.576l81.792 89.109334 136.608-136.992a32 32 0 1 1 45.312 45.184l-160.213333 160.682666a32 32 0 0 1-46.24-0.96z" fill="#000000" p-id="4671"></path></svg>',
    },
    children: [
      {
        path: "index",
      ...
      },
      {
        ...
        meta: { title: "流量统计", hidden: true },
      },
      {
        path: "log",
        name: "log",
        component: () => import("@/pages/data/log/index.vue"),
        meta: { title: "URL日志", hidden: true },
      },
      {
        path: "analysis",
        name: "analysis",
    ...
    children: [
      ...
      },
      {
        ...
        meta: {
          title: "添加编辑",
          hidden: true,
          fmeta: { path: "/marketing/index", title: "优惠券管理" },
        },
      },
      {
        path: "details/:id",
    ...
    children: [
      ...
      },
      {
        ...
        meta: {
          title: "添加编辑",
          hidden: true,
          fmeta: { path: "/message/template", title: "模板管理" },
        },
      },
      {
    ...
    children: [
      ...
      },
      {
        ...
        meta: {
          title: "问题详情",
          hidden: true,
          fmeta: { path: "/interactive/index", title: "问答管理" },
        },
      },
      {
        path: "replies",
      ...
      },
      {
        ...
        meta: {
          title: "笔记详情",
          hidden: true,
          fmeta: { path: "/note/index", title: "笔记管理" },
        },
      },
    ],
  },
    ...
    children: [
      ...
      },
      {
        ...
        meta: {
          title: "订单详情",
          hidden: true,
          fmeta: { path: "/order/index", title: "订单管理" },
        },
      },
      {
        ...
        meta: {
          title: "退款详情",
          hidden: true,
          fmeta: { path: "/order/refund", title: "退款管理" },
        },
      },
      {
        ...
        meta: {
          title: "对账详情",
          hidden: true,
          fmeta: { path: "/order/reconciliation", title: "订单管理" },
        },
      },
    ],
  },
